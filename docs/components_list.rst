.. table:: List of registered components
    ...
    GratingCoupler2D            2-D grating coupler
    EdgeCoupler                 Edge coupler 
    Crossing                    Waveguide crossing
    Taper                       Waveguide taper 
    Bend                        Bend (Euler, arc, etc.) 
    Terminator                  Optical terminator 
    Waveguide                   Waveguide
    WaveguideConverter      
    ModeConverter    
    RingResonator
    PolarisationFilter          Polarisation filters 
    PolarisationSplitter1x2
    PolarisationSplitter2x2
    PolarisationRotator         Polarisation rotators 
